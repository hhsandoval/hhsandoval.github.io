...
1. [Mexico’s Energy Crossroads: Navigating a Complex Transition](https://www.sciencedirect.com/science/article/pii/S0301421526001588?dgcid=coauthor) 
with Brandon García and Pedro Hancevic. *<span style="color: #2B1B17"> Energy Policy (accepted)</span>, 2026* <button class="block" onclick="myFunction('paper15');"> Show/Hide Abstract </button>  
   <div id="paper15" style="display:none;"> <p style="font-size:90%;"> <b>Abstract:</b> Despite statutory targets to achieve a 35% clean electricity generation share by 2024, Mexico continues to rely on fossil fuels for over 75% of its power. While installed clean capacity has reached 36.9%, actual generation has lagged significantly at approximately 24.3%. This paper examines the disconnect between Mexico's vast renewable energy potential and its failure to meet its legal clean energy goals, even as wind and solar costs have plummeted. We argue that the primary barriers are not technological or economic, but institutional, regulatory, and infrastructural. We identify three key constraints: (1) regulatory reversals and market uncertainty that have eroded investor confidence; (2) critical infrastructure bottlenecks in transmission and the absence of a regulatory framework for energy storage; and (3) an increasing dependence on imported natural gas, which acts as a structural enabler for the regulatory foreclosure of renewables. We also analyze complementary issues such as electricity pricing distortions and limited regional market integration. Based on this analysis, the paper outlines a ``second-best'' policy roadmap to align Mexico’s state-centric governance with its decarbonization goals. These findings offer insights for middle-income countries navigating similar complex energy transitions.</p> </div>

2. [Opportunistic Behavior and Discrimination in the Mexican Solar Photovoltaic Market: An Audit Experiment](https://doi.org/10.1016/j.worlddev.2025.107196) 
with Hernán Bejarano and Pedro Hancevic. *<span style="color: #2B1B17"> World Development </span>, 2026* <button class="block" onclick="myFunction('paper14');"> Show/Hide Abstract </button>  
...
3. [Hurricanes and Labor Market Disruptions: Insights from Unemployment Insurance Claims](https://doi.org/10.1016/j.econlet.2025.112531) 
...
4. [The Hidden Costs of Tariff Misclassification: Structural Winners and Losers ](https://doi.org/10.1016/j.eneco.2025.108322) 
...
5. [Split Incentives in Emerging Countries](https://doi.org/10.1177/01956574241281107) 
...
6. [Gender Gap in Consumer Expectations](https://doi.org/10.1080/13504851.2024.2389339) 
...
7. [Sentiments and Spending Intentions: Evidence from Florida](https://doi.org/10.1111/ecin.13215) 
...
8. [Solar Panel Adoption among Mexican Small and Medium-Sized Commercial and Service Businesses](https://doi.org/10.1016/j.eneco.2023.106979) 
...
9. [Differential Impact of COVID-19 on the Energy Consumption of Residential and Business Sectors](http://www.iaee.org/eeep/article/451) 
...
10. [The Impacts of Fare-Free Bus Programs on Educational Outcomes of K-12 Students](https://www.journals.uchicago.edu/doi/10.1086/721376) 
...
11. [Low Income Energy Efficiency Programs and Energy Consumption](https://doi.org/10.1016/j.jeem.2022.102656)
...
12. [The Role of Consumer Confidence in Forecasting Consumption, Evidence from Florida](https://doi.org/10.1002/soej.12528)
...
13. [Social Capital in Labor Market Access and Poverty in Mexico](http://biblioteca.ciess.org/adiss/r458/social_capital_in_labor_market_access_and_poverty_in_mexico)
...
14. [Negative Net Incomes and the Measurement of Poverty: A Note](https://ideas.repec.org/a/ega/rafega/200903.html)
...
15. [TIPs for the Analysis of Poverty in Mexico, 1992-2005](https://ideas.repec.org/a/ega/rafega/200806.html)
...
1. [Energy Efficiency Audits for Small Firms in Mexico](https://hhsandoval.github.io/) 
 with Hernán Bejarano and Pedro Hancevic *(revised version forthcoming)* <button class="block" onclick="myFunction('wpaper3');"> Show/Hide Abstract </button>  
