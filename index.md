...
1. [Opportunistic Behavior and Discrimination in the Mexican Solar Photovoltaic Market: An Audit Experiment](https://doi.org/10.1016/j.worlddev.2025.107196) 
...
1. [Mexico's Energy Crossroads: Navigating a Complex Transition](https://hhsandoval.github.io/) 
 with Brandon García and Pedro Hancevic *(revise & resubmit)* <button class="block" onclick="myFunction('wpaper2');"> Show/Hide Abstract </button>  
