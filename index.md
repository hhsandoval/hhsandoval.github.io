...
1. [Split Incentives in Emerging Countries](https://rednie.eco.unc.edu.ar/files/DT/242.pdf) 
  with Pedro Hacevic  *<span style="color: #2B1B17"> Energy Journal (accepted) </span>*  <button class="block" onclick="myFunction('wpaper2');"> Show/Hide Abstract </button>   
...
2. [Gender Gap in Consumer Expectations](https://hhsandoval.github.io/) 
   *<span style="color: #2B1B17"> Applied Economics Letters (accepted) </span>* <button class="block" onclick="myFunction('wpaper3');"> Show/Hide Abstract </button>  
