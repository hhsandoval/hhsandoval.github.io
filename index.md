...
1. [Mexico’s Energy Crossroads: Navigating a Complex Transition](https://www.sciencedirect.com/journal/energy-policy) 
with Brandon García and Pedro Hancevic. *<span style="color: #2B1B17"> Energy Policy (accepted) </span>, 2026* <button class="block" onclick="myFunction('paper155');"> Show/Hide Abstract </button>  
